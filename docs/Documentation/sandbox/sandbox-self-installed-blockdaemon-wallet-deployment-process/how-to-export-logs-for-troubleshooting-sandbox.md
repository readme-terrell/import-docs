...
To facilitate exporting logs to Blockdaemon, we have included a lambda function. It can be found in the resources tab of the wallet long-lived stack with the logical ID `ExportLogsLambda`, as shown below.
